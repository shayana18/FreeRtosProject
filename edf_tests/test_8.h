 ...
 * - Two tasks intentionally overrun their WCET budget on periodic jobs by
 *   spinning past the allocated execution budget, triggering the EDF kernel's
 *   budget-enforcement path and causing observable deadline-miss events.
 *
